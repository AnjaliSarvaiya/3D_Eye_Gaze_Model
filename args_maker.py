...
elif username == 'ml' and host == 'Machine-Learning':
    # Paths for your specific setup
    os.environ["WANDB_DIR"] = "/media/ml/03C90A2604F5F8BA/Anjali/Model-aware_3D_Eye_Gaze-main/Results/wandb"
    masterkey_root = '/media/ml/03C90A2604F5F8BA/Anjali/Model-aware_3D_Eye_Gaze-main/Datasets/MasterKey'
    dataset_root = '/media/ml/03C90A2604F5F8BA/Anjali/Model-aware_3D_Eye_Gaze-main/Datasets/All'
    results_root = '/media/ml/03C90A2604F5F8BA/Anjali/Model-aware_3D_Eye_Gaze-main/Results'
    default_repo = '/media/ml/03C90A2604F5F8BA/Anjali/Model-aware_3D_Eye_Gaze-main'
    print('User ml on ml-All-Series')
else:
