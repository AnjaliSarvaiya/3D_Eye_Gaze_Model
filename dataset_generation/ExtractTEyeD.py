...
def make_args():
    ...
    parser.add_argument('--path2ds', type=str, default='/media/ml/Data Disk/Anjali/Model-aware_3D_Eye_Gaze-main/Datasets',
                        help='path to datasets')
    parser.add_argument('--path_data', type=str, default='/media/ml/Data Disk/Anjali/Model-aware_3D_Eye_Gaze-main/Datasets/TEyeD/TEyeDSSingleFiles/Dikablis',
...
if __name__ == '__main__':
    ...
    list_videos = [x for x in list_videos if x.endswith(".mp4") or x.endswith(".avi")]
    print("Found video files:", list_videos)
